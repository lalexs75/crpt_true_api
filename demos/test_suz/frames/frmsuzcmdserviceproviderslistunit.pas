...
unit frmSUZCmdServiceProvidersListUnit;
...
type
  ...
  { TfrmSUZCmdServiceProvidersListFrame }

  TfrmSUZCmdServiceProvidersListFrame = class(TfrmSUZCmdAbstractFrame)
    Button1: TButton;
    Memo1: TMemo;
...
procedure TfrmSUZCmdServiceProvidersListFrame.Button1Click(Sender: TObject);
var
  P1: TJSONObject;
begin
  Memo1.Lines.Clear;
...
function TfrmSUZCmdServiceProvidersListFrame.FrameName: string;
begin
  Result:='Список сервис-провайдеров';
end;
