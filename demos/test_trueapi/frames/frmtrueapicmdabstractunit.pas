...
unit frmTrueAPICmdAbstractUnit;
...
uses
  Classes, SysUtils, Forms, Controls, IniFiles, CRPTTrueAPI, CRPTTrueAPI_Consts;
...
procedure TfrmTrueAPICmdAbstractFrame.SaveParams(AIni: TIniFile);
begin
